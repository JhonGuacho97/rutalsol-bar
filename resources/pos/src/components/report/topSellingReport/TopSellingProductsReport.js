...
const TopSellingProductsReport = (props) => {
    ...
    useEffect(() => {
        if (isWarehouseValue === true) {
            downloadExcel(`top-selling-product-report-excel?start_date=${dates.start_date ?? null}&end_date=${dates.end_date ?? null}`, 'top_selling_product_excel_url', () => setIsWarehouseValue(false));
        }
    }, [isWarehouseValue]);
