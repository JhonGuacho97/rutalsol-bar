...
import { clearMainProduct, fetchMainProduct } from "../../store/action/productAction";
...
const ProductDetail = (props) => {
    ...
    const result = products && products.length > 0
        ...
        : {};
    const product = result.products || null;
...
export default connect(mapStateToProps, { fetchMainProduct, clearMainProduct })(ProductDetail);
