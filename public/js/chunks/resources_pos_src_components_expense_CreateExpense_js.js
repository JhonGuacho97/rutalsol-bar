(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_pos_src_components_expense_CreateExpense_js"],{
...
/***/ "./resources/pos/src/shared/datepicker/ReactDatePicker.js"
/*!****************************************************************!*\
  !*** ./resources/pos/src/shared/datepicker/ReactDatePicker.js ***!
  \****************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var date_fns_locale__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns/locale */ "./node_modules/date-fns/esm/locale/ar/index.js");
/* harmony import */ var date_fns_locale__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! date-fns/locale */ "./node_modules/date-fns/esm/locale/de/index.js");
...
/* harmony import */ var date_fns_locale__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! date-fns/locale */ "./node_modules/date-fns/esm/locale/es/index.js");
/* harmony import */ var date_fns_locale__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! date-fns/locale */ "./node_modules/date-fns/esm/locale/fr/index.js");
/* harmony import */ var date_fns_locale__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! date-fns/locale */ "./node_modules/date-fns/esm/locale/tr/index.js");
/* harmony import */ var date_fns_locale__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! date-fns/locale */ "./node_modules/date-fns/esm/locale/vi/index.js");
/* harmony import */ var date_fns_locale__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! date-fns/locale */ "./node_modules/date-fns/esm/locale/zh-CN/index.js");
...
var ReactDatePicker = function ReactDatePicker(props) {
  var onChangeDate = props.onChangeDate,
  ...
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(date_fns_locale__WEBPACK_IMPORTED_MODULE_6__["default"]),
    _useState4 = _slicedToArray(_useState3, 2),
    language = _useState4[0],
    setLanguage = _useState4[1];
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("enGB"),
    _useState6 = _slicedToArray(_useState5, 2),
    languageCode = _useState6[0],
    setLanguageCode = _useState6[1];
  ...
  var updatedLanguage = localStorage.getItem(_constants__WEBPACK_IMPORTED_MODULE_13__.Tokens.UPDATED_LANGUAGE);
  var _useSelector2 = (0,react_redux__WEBPACK_IMPORTED_MODULE_12__.useSelector)(function (state) {
      return state;
    }),
    selectedLanguage = _useSelector2.selectedLanguage;
  var messages = updatedLanguage ? updatedLanguage : selectedLanguage;
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (messages === "en") {
      setLanguage(date_fns_locale__WEBPACK_IMPORTED_MODULE_6__["default"]);
      setLanguageCode("enGB");
    } else if (messages === "sp") {
      setLanguage(date_fns_locale__WEBPACK_IMPORTED_MODULE_7__["default"]);
      setLanguageCode("es");
    } else if (messages === "gr") {
      setLanguage(date_fns_locale__WEBPACK_IMPORTED_MODULE_5__["default"]);
      setLanguageCode("de");
    } else if (messages === "fr") {
      setLanguage(date_fns_locale__WEBPACK_IMPORTED_MODULE_8__["default"]);
      setLanguageCode("fr");
    } else if (messages === "ar") {
      setLanguage(date_fns_locale__WEBPACK_IMPORTED_MODULE_4__["default"]);
      setLanguageCode("ar");
    } else if (messages === "tr") {
      setLanguage(date_fns_locale__WEBPACK_IMPORTED_MODULE_9__["default"]);
      setLanguageCode("tr");
    } else if (messages === "vi") {
      setLanguage(date_fns_locale__WEBPACK_IMPORTED_MODULE_10__["default"]);
      setLanguageCode("vi");
    } else if (messages === "cn") {
      setLanguage(date_fns_locale__WEBPACK_IMPORTED_MODULE_11__["default"]);
      setLanguageCode("cn");
    }
  }, [messages]);
  (0,react_datepicker__WEBPACK_IMPORTED_MODULE_1__.registerLocale)(language, languageCode);
  var handleCallback = function handleCallback(date) {
    setStartDate(date);
    onChangeDate(date);
  };
  ...
  var onDatepickerRef = function onDatepickerRef(el, readOnlyref) {
    if (el && el.input) {
      el.input.readOnly = readOnlyref !== undefined ? readOnlyref : true;
    }
  };
  var format = function format(allConfigData) {
    var format = allConfigData && allConfigData.date_format;
    if (format === "d-m-y") {
      return "dd-MM-yyyy";
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)("div", {
    className: "position-relative datepicker p-0",
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)((react_datepicker__WEBPACK_IMPORTED_MODULE_1___default()), {
      wrapperClassName: "w-100",
      locale: language,
      className: "datepicker__custom-datepicker px-4",
      name: "date",
      selected: newStartDate === null ? new Date() : newStartDate ? newStartDate : startDate,
      dateFormat: format(allConfigData),
      onChange: function onChange(date) {
        return handleCallback(date);
      },
      maxDate: new Date(),
      ref: function ref(el) {
        return onDatepickerRef(el, readOnlyref);
      }
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_2__.FontAwesomeIcon, {
